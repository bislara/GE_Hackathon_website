 window.onload = function () {
        ...
        var updateChart = function (count) {
          ...
          for (var j = 0; j < count; j++) {
            ...
            if (yVal>threshold) 
            {
                //ajax request patheibi to a particular file for few interval
                // $.ajax({
                //     url: 'apis/send_data.php',
                //     type: 'POST',
                //     data: {
                //         limit: "limit crossed"
                //     },
